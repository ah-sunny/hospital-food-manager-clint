...
const [nightFood, setnightFood] = React.useState([])

    const handlenightFood =(event)=>{
        const {
          target: { value },
        } = event;
        setnightFood(
               ...
               >
                 {names.map((name) => (
                   <MenuItem
                     key={name}
                     value={name}
                     style={getStyles(name, nightFood, theme)}
                   >
                     {name}
                   </MenuItem>
                 ))}
